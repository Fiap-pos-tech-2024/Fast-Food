...
describe('ClientController', () => {
    ...
    describe('listClients', () => {
        ...
        it('should return 500 on error', async () => {
            mockClientUseCase.listClients.mockRejectedValue(new Error('Error fetching clients'));
    ...
    describe('createClient', () => {
        it('should create a new client', async () => {
            ...
            expect(mockClientUseCase.createClient).toHaveBeenCalledWith(req.body);
        ...
        it('should return 500 on other errors', async () => {
            req.body = Client.createMock();
            mockClientUseCase.createClient.mockRejectedValue(new Error('Unexpected error'));
    ...
    describe('updateClient', () => {
        it('should update a client', async () => {
            ...
            expect(mockClientUseCase.updateClient).toHaveBeenCalledWith('1', req.body);
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.send).toHaveBeenCalledWith('Client 1 updated successfully');
        });

        it('should return 500 on error', async () => {
            req.params = { id: '1' };
            req.body = Client.createMock();
            mockClientUseCase.updateClient.mockRejectedValue(new Error('Error updating client'));
    ...
    describe('deleteClient', () => {
        it('should delete a client', async () => {
            ...
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.send).toHaveBeenCalledWith('Client 1 deleted successfully');
        });

        it('should return 500 on error', async () => {
            req.params = { id: '1' };
            mockClientUseCase.deleteClient.mockRejectedValue(new Error('Error deleting client'));
    ...
    describe('getClient', () => {
        ...
        it('should return 500 on error', async () => {
            req.params = { id: '1' };
            mockClientUseCase.getClient.mockRejectedValue(new Error('Error fetching client'));
