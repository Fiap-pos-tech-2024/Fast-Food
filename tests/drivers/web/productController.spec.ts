...
describe('ProductController', () => {
    ...
    describe('listProducts', () => {
        ...
        it('should return 500 on error', async () => {
            mockProductUseCase.listProducts.mockRejectedValue(new Error('Error fetching products'));
    ...
    describe('listProductsByCategory', () => {
        it('should return a list of products by category', async () => {
            ...
            mockProductUseCase.listProductsByCategory.mockResolvedValue(products);

            await productController.listProductsByCategory(req as Request, res as Response);

            expect(mockProductUseCase.listProductsByCategory).toHaveBeenCalledWith('Electronics');
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.json).toHaveBeenCalledWith(products);
        });
        ...
        it('should return 500 on error', async () => {
            req.params = { category: 'Electronics' };
            mockProductUseCase.listProductsByCategory.mockRejectedValue(new Error('Error fetching products by category'));

            await productController.listProductsByCategory(req as Request, res as Response);

            expect(res.status).toHaveBeenCalledWith(500);
            expect(res.send).toHaveBeenCalledWith('Error fetching products by category');
        });
    });
    ...
    describe('createProduct', () => {
        it('should create a new product', async () => {
            ...
            expect(mockProductUseCase.createProduct).toHaveBeenCalledWith(req.body);
    ...
    describe('updateProduct', () => {
        it('should update a product', async () => {
            ...
            expect(mockProductUseCase.updateProduct).toHaveBeenCalledWith('1', req.body);
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.send).toHaveBeenCalledWith('Product 1 updated successfully');
        });

        it('should return 500 on error', async () => {
            req.params = { id: '1' };
            req.body = Product.createMock();
            mockProductUseCase.updateProduct.mockRejectedValue(new Error('Error updating product'));
    ...
    describe('deleteProduct', () => {
        it('should delete a product', async () => {
            ...
            expect(res.status).toHaveBeenCalledWith(200);
            expect(res.send).toHaveBeenCalledWith('Product 1 deleted successfully');
        });

        it('should return 500 on error', async () => {
            req.params = { id: '1' };
            mockProductUseCase.deleteProduct.mockRejectedValue(new Error('Error deleting product'));
    ...
    describe('getProduct', () => {
        ...
        it('should return 500 on error', async () => {
            req.params = { id: '1' };
            mockProductUseCase.getProduct.mockRejectedValue(new Error('Error fetching product'));
